...
class EntitiesProxy {
  ...
  // constructor(baseUrl: string = "" +"/BACKEND_PROJ_43bb5105_snap_20260716_073319_373_snap_20260716_073319_373"+"/api/entities") {
  //   this.baseUrl = baseUrl;
  // }
  constructor(
    baseUrl: string = '' +
      '/backendcommon/api/zaki/PROJ_43bb5105_snap_20260716_073319_373_snap_20260716_073319_373' +
      '/entities-handler'
  ) {
    ...
    this.baseUrl =
      ...
      (dynamicBase
        ? '' +
          ...
          '/entities-handler'
        : '' +
          '/backendcommon/api/zaki/PROJ_43bb5105_snap_20260716_073319_373_snap_20260716_073319_373/entities-handler');
  }
