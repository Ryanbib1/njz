...
exports.commonRedirectPlugin = commonRedirectPlugin;
 ...
 */
function commonRedirectPlugin(outDir) {
    return {
        ...
        setup(build) {
            ...
            build.onResolve({ filter: /prisma-generated\/client/ }, (args) => {
                ...
                if (args.namespace === 'common-redirect')
                    return undefined;
                return {
                    path: args.path,
                    namespace: 'common-redirect',
 ...
 */
function encodeOutputFilename(sourceFile) {
    return sourceFile
