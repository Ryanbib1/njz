...
export interface ChatCompletionParams {
    ...
    /** Model name (optional, uses AI_DEFAULT_MODEL from common.ts if not specified) */
    model?: string;
...
export interface ImageGenerationParams {
    ...
    prompt: string;
    /** Model name (optional, uses AI_IMAGE_DEFAULT_MODEL from common.ts if not specified) */
    model?: string;
